  ...
  return (
    <div className="bg-white text-gray-800 min-h-screen flex items-center justify-center p-4">
      <div className="prose lg:prose-xl mx-auto max-w-2xl">
        ...
        <p>
          Welcome to Nex Core Aliance LLP. By accessing or using our website
          (www.nexcorealiance.com) and services provided under the brands ISRC
        ...
        <p>
          Nex Core Aliance LLP reserves the right to modify or update these Terms
        ...
        <p>
          All content, materials, trademarks, and logos displayed on the Nex
          Core Aliance LLP website, including those of ISRC, Code4Bharat, and
        ...
        <p>
          ...
          ISRC's event rules and regulations. Nex Core Aliance LLP holds no
        ...
        <p>
          Nex Core Aliance LLP, including its brands ISRC, Code4Bharat, and
        ...
        <p>
          Nex Core Aliance LLP reserves the right to suspend or terminate user
